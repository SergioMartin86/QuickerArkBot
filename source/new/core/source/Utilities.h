...
class FileUtil
{
  ...
  static void SetWorkingDir(std::string &&dir) { workingDir = dir; }

  static std::string WorkingDir() { return ""; }

  static std::string UnitTestDir() { return ""; }

  static std::string ResultsDir() { return ""; }

  static std::string PartialsDir() { return ""; }

  static std::string ScoreVarDir() { return ""; }
...
class Log
{
  ...
  static void Clear() { FileUtil::ClearFile(FileUtil::ResultsDir() + "Output.txt"); }

  static void Write(const std::string &text) { FileUtil::AppendToFile(FileUtil::ResultsDir() + "Output.txt", text); }
};