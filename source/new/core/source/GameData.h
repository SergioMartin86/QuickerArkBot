...
namespace Data
{
    constexpr unsigned int EnemySpawnTimerTable[40][3] = {
        { 0,  0,  0 },
        { 0x708,  0xe10,  0x1518 },
        { 0,  0x0708,  0xe10 },
        { 0,  0,  0 },
    ...
    constexpr unsigned int LevelBlockCount[] = {
    ...
    constexpr unsigned int StartingSpeedStage[] = {
        7, 7, 7, 7, 7, 7, 7, 8,
        7, 8, 6, 7, 6, 8, 7, 8,
        6, 7, 7, 7, 7, 7, 8, 7,
        7, 7, 8, 6, 8, 7, 7, 7,
    ...
    constexpr unsigned int SpecialPowerupTable[] = {
    ...
    constexpr unsigned int CeilingBounceSpeedStage[] = {
        0,
        8, 8, 8, 0, 8, 8, 0, 0,
        8, 7, 8, 8, 9, 7, 0, 7,
        8, 8, 8, 0, 8, 0, 0, 0,
    ...
    constexpr unsigned int MinBlockRow[] = {
        0,
        4, 2, 3, 4, 2, 3, 4, 3,
        2, 0, 4, 2, 4, 3, 3, 2,
        2, 3, 3, 3, 3, 3, 2, 5,
    ...
    constexpr unsigned int MaxBlockRow[] = {
        0,
